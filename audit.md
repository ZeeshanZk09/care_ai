...
| End-to-end test coverage           | repository-wide                                                                  | No test files detected (_.test / _.spec / **tests**). Regression risk is high for billing/auth/growth automation.                  | CRITICAL |
