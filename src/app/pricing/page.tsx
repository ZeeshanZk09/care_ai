...
export default async function PricingPage() {
  ...
  if (userId) {
    try {
      ...
      console.error(
        "[pricing] Failed to load current entitlement snapshot:",
        error,
      );
    }
  }
    ...
    <div className="section-container">
      ...
      <div className="text-center">
        <h1 className="heading-1">
          Simple, Transparent Pricing for AI Medical Consultations
        </h1>
        <p className="subtext mx-auto mt-4">
          Compare flexible plans for affordable AI health consultation
          workflows, from free trial onboarding to unlimited Pro support.
        </p>
      </div>
      ...
      <section className="mt-14 rounded-xl border bg-muted/40 p-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
          Begin with 10 free consultations and upgrade only when you need higher
          monthly capacity.
        </p>
