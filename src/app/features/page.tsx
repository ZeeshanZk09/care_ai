    ...
    <div className="section-container">
      ...
      <header className="max-w-3xl">
        <h1 className="heading-1">
          Powerful Features for AI-Driven Medical Voice Consultation
        </h1>
      ...
      <section className="mt-10 rounded-xl border bg-muted/40 p-6">
        ...
        <p className="mt-3 text-muted-foreground">
          MediVoice AI helps clinics, startups, and digital care teams deliver
          faster first-line guidance without sacrificing quality.
        </p>
      ...
      <RelatedLinks
        ...
        links={[
          {
            href: "/symptoms/chest-pain-triage",
            label: "Chest Pain Triage Guide",
            description:
              "Structured warning signs and consultation preparation checklist.",
          },
          {
            href: "/faq/specialist-routing",
            label: "Specialist Routing FAQ Cluster",
            description:
              "Understand how symptom context routes to specialist pathways.",
          },
          {
            href: "/pricing",
            label: "Pricing Plans",
