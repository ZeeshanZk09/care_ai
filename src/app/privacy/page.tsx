  ...
  return (
    <div className="section-container">
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>Welcome to CareAI. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website.</p>
        ...
        <ul>
          ...
          <li><strong>Health Data:</strong> includes symptoms, consultation notes, and AI analysis reports.</li>
        </ul>
        ...
        <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorised way. We do not sell your personal data to third parties.</p>
      </div>
    </div>
  );
}
