    ...
    <section className='relative w-full mx-auto max-w-7xl my-10'>
      {currentPlan === 'FREE' ? (
        <article className='mx-4 mb-8 rounded-xl border bg-card p-5 shadow-sm'>
          ...
          <h2 className='mt-2 text-2xl font-semibold'>Unlock stronger reports and better value</h2>
          <p className='mt-2 text-sm text-muted-foreground'>
            You currently have {consultationsRemaining ?? 0} free consultations remaining. Upgrade
            to improve report depth and reduce consultation bottlenecks.
          </p>
          ...
          <div className='mt-4 grid gap-3 md:grid-cols-3'>
            ...
            <div className='rounded-lg border p-3'>
              ...
              <p className='mt-1 text-xs text-muted-foreground'>
                50 consultations/month with specialist routing and faster outputs.
              </p>
            </div>
            <div className='rounded-lg border p-3'>
              <p className='text-sm font-semibold'>Pro</p>
              <p className='mt-1 text-xs text-muted-foreground'>
                Unlimited consultations, premium model quality, and comprehensive reports.
              </p>
            </div>
          </div>
      ...
      <ExitIntentLeadCapture
        ...
        description='Use this free template to speed up your next consultation and improve report quality.'
      />
    </section>
  );
}
