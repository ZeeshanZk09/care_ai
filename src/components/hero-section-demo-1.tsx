    ...
    <>
      ...
      <div className="relative z-10 mx-auto max-w-7xl  flex items-center justify-between gap-8 ">
        <div className="px-4 py-10 md:py-20">
          ...
          >
            Deliver personalized, efficient, and compassionate care with our AI
            voice agents, designed to enhance patient engagement and streamline
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-1 dark:border-neutral-800">
      <div className="flex items-end cursor-pointer">
        ...
        />
        <h1 className="relative -left-1 bottom-1 text-base md:text-2xl lg:text-3xl">
          CareAI
        </h1>
      </div>
